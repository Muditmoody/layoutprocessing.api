...
{
    /// <summary>
    /// Cleaned Model Input data model
    /// </summary>
    public class ExtractCleanModelInput : IExtractObjects
    {
        /// <summary>
        /// Gets or sets the id.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtractCleanModelInput"/> class.
        /// </summary>
        ...
        public ExtractCleanModelInput(int id, string notificationCode, int itemNumber, int layoutTaskId, int taskNumber, string materialCode,
        ...
        /// <returns>An ExtractCleanModelInput.</returns>
        public static ExtractCleanModelInput Map(Model.CleanModelInput item) => new ExtractCleanModelInput
        {
            Id = item.Id,
            ...
            EngineProgram = item.EngineProgram,
